...
class Users(object):
    ...
    def _define_tables(self):
        ...
        #self.db.auth_user.email.requires=[IS_LOWER(),IS_EMAIL(),IS_NOT_IN_DB(self.db, 'auth_user.email')]
        #self.auth.auth_table.email.requires = IS_LOWER()
    ...
    def to_know(self, status):
        if status == 'active':
            ...
            set_db = SessionSetDb('web2py_session_cas', self.db)
